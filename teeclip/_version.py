"""
Version information for teeclip.
...
Example: 0.1.0_main_4-20260216-a1b2c3d4
...
__version__ = "0.2.1-alpha_main_7-20260217-6925fa64"
...
def get_pip_version():
    ...
    - Main branch: 0.1.0-alpha_main_6-20260216-hash -> 0.1.0a1
    - Dev branch: 0.1.0-alpha_dev_6-20260216-hash -> 0.1.0a1.dev6
    - Feature branch: 0.1.0_feature_6-20260216-hash -> 0.1.0.dev6+feature
    """
    base = f"{MAJOR}.{MINOR}.{PATCH}"
